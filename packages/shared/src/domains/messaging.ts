    ...
    switch (code) {
        case 'invalid_requester_did':
            return {
                ...
                message:
                    'Your account identity is invalid. Refresh and try again.',
            };
        case 'invalid_recipient_did':
            return {
                ...
                title: 'Cannot start chat',
                message:
                    'This helper account is invalid or unavailable right now.',
            };
        case 'invalid_post_uri':
            return {
                ...
                title: 'Cannot start chat',
                message:
                    'The request context is invalid. Open the post again and retry.',
            };
        ...
        case 'recipient_not_available':
            return {
                ...
                message:
                    'This helper is not accepting chats at the moment. Try a different destination.',
            };
        case 'requester_blocked_recipient':
            return {
                ...
                title: 'Chat blocked',
                message:
                    'You blocked this account. Unblock first to start a chat.',
            };
        case 'recipient_blocked_requester':
            return {
                ...
                title: 'Chat unavailable',
                message:
                    'This account is not available for direct chat. Try an alternative handoff path.',
            };
    }
}
...
export function validateConversationPermissions(
    input: Pick<
        PostLinkedChatInitiationInput,
        'requesterDid' | 'recipientDid' | 'postUri'
    >,
...
export function initiatePostLinkedChat(
    ...
    return {
        ...
        ux: {
            ...
            title: 'Chat ready',
            message:
                'Conversation opened with request context attached for safe handoff.',
        },
    };
}
