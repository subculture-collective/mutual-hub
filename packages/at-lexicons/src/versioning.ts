...
export const LEXICON_VERSION_POLICY = {
  ...
  additive: 'Additive optional fields increment MINOR (1.x.0) and preserve backward compatibility.',
  breaking: 'Breaking changes increment MAJOR and require migration notes before rollout.',
...
export const isSemver = (value: string): boolean => /^(0|[1-9]\d*)\.(0|[1-9]\d*)\.(0|[1-9]\d*)$/.test(value);
