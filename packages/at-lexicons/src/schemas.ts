...
const didSchema = z
    .string()
    .regex(/^did:[a-z0-9:._%-]+$/i, 'Expected a DID string');
const atUriSchema = z
    .string()
    .regex(/^at:\/\/[^/]+\/[a-z0-9.]+\/.+$/i, 'Expected a valid AT URI');
...
export type VolunteerProfileLexiconRecord = z.infer<
    typeof volunteerProfileRecordSchema
>;
export type ConversationMetadataLexiconRecord = z.infer<
    typeof conversationMetadataRecordSchema
>;
export type ModerationReportLexiconRecord = z.infer<
    typeof moderationReportRecordSchema
>;
export type ResourceDirectoryLexiconRecord = z.infer<
    typeof resourceDirectoryRecordSchema
>;
...
export type AtRecordForCollection<C extends AtCollectionName> =
    AtRecordByCollection[C];
