    ...
    return cards.filter(card => {
        ...
        if (query.since) {
            ...
            if (
                ...
                (Number.isNaN(updatedAtMs) || updatedAtMs < sinceMs)
            ) {
                return false;
            }
        }
...
export function toFeedCardPresentation(
    card: FeedAidCard,
    ...
    return {
        ...
        chatActionLabel: 'Start chat',
        chatActionAriaLabel: `Start chat for ${card.title}`,
    };
}
