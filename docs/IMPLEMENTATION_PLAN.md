...
4. Phase 4 — Core UX: map + feed + posting (_depends on 3; 4.2 parallel with 4.1 after shared UI primitives exist_)
...
6. Phase 6 — v1 extras requested by user (_depends on 3; parallel with 4/5 for UI pieces_)
...
7. Phase 7 — Moderation, trust, and privacy hardening (_depends on 4/5/6_)
...
8. Phase 8 — Verification, launch readiness, and pilot rollout (_depends on 1-7_)
...
- `/home/onnwee/Documents/Code/onnwee/mutual-hub/docs/CHAT_ROUTING_RULES.md` — Deterministic routing rule order and fallback hierarchy.
